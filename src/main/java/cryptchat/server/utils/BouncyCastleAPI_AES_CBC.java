...
//		encryptCipher = new PaddedBufferedBlockCipher(new CBCBlockCipher(new AESEngine()));
		encryptCipher = new PaddedBufferedBlockCipher(CBCBlockCipher.newInstance(AESEngine.newInstance()));

//		decryptCipher = new PaddedBufferedBlockCipher(new CBCBlockCipher(new AESEngine()));
		decryptCipher = new PaddedBufferedBlockCipher(CBCBlockCipher.newInstance(AESEngine.newInstance()));
	...
	public void CBCEncrypt(InputStream in, OutputStream out) throws ShortBufferException, IllegalBlockSizeException,
	...
	public void CBCDecrypt(InputStream in, OutputStream out) throws ShortBufferException, IllegalBlockSizeException,
			BadPaddingException, DataLengthException, IllegalStateException, InvalidCipherTextException, IOException {
